  ...
  return (
    <div className="flex items-center justify-center h-screen">
      ...
      >
        ...
        {error && (
          <p className="text-red-500 text-sm text-center -mt-6 mb-4">{error}</p>
        )}
        ...
        <button
          ...
          className="w-full mb-3 bg-indigo-500 hover:bg-indigo-600/90 transition py-2.5 rounded text-white font-medium disabled:opacity-60"
        >
